...
public class ImageClassifierActivity extends ImageHelperActivity {
        ...
        imageLabeler.process(inputImage).addOnSuccessListener(new OnSuccessListener<List<ImageLabel>>() {
            ...
            public void onSuccess(List<ImageLabel> imageLabels) {
                if(imageLabels.size()>0){
                    ...
                    getTvResultado().setText(builder.toString());
                }else{
                    getTvResultado().setText("Nao foi possivel classificar a imagem");
                }
